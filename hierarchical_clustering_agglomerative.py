...
Original file is located at
    https://colab.research.google.com/drive/1ceJgZEVmPiTzZxfiBUtoCmXCeEuPdUeQ
...
# Save the dendrogram to a variable called dendro. In doing this, the dendrogram will also be displayed. Using the dendrogram class from hierarchy, pass in the parameter: Z

dendro = hierarchy.dendrogram(Z)

#  Use complete linkage for our case, change it to average linkage to see how the dendogram changes.
...
pdf = pd.read_csv(url)
print("Shape of Dateset:    ", pdf.shape)
...
#  we can normalize the feature set. MinMaxScaler transforms features by scaling each feature to a given range. It is by default (0, 1). That is, this estimator scales and translates each feature individually such that it is between zero and one.
...
# Use complete for our case, but feel free to change it to see how the results change.
